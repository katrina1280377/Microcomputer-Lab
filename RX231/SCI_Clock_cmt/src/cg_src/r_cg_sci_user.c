...
int sminute,ssecond,shour;
extern int shine,flag,ring;
char r[9]={0};
char up[15]="\r\n wake up\r\n";
extern char change[1];
/* End user code. Do not edit comment generated here */
...
static void r_sci5_callback_transmitend(void)
{
	...
	if(ring)
	{R_SCI5_Serial_Send(up,15);ring=0;}
...
static void r_sci5_callback_receiveend(void)
{
	...
	else if(shine)
	{
		...
		if(r[8]=='\r')
		{
			shour=(r[0]-'0')*10+(r[1]-'0');
			sminute=(r[3]-'0')*10+(r[4]-'0');
			ssecond=(r[6]-'0')*10+(r[7]-'0');
