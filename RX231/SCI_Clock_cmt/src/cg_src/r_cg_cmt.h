...
Macro definitions
***********************************************************************************************************************/
#define _CDFD_CMT0_CMCOR_VALUE                  (0xCDFDU) /* Compare match value */
...
extern int minute,second,hour,ssecond,shour,sminute,shine,ring;
extern char time[9], min[2],sec[2],hr[2],input[1],t[9];
