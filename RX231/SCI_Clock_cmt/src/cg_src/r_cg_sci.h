...
#define _00_SCI_DATA_TRANSMISSION_CYCLE           (0x00U) /* Multiprocessor Asynchronous ID Transmission Cycle  */
...
extern int minute,second,hour,shine,sminute,ssecond,shour,flag,k;
extern char time[9],input[1], min[2],sec[2],t[9],hr[2],change[1],r[9],up[15],change[1];
