...
Macro definitions
***********************************************************************************************************************/
#define _0034_CMT0_CMCOR_VALUE                  (0x0034U) /* Compare match value */
#define _1498_CMT1_CMCOR_VALUE                  (0x1498U) /* Compare match value */
...
extern int x,num,value,alarm;
extern char output[10],clock[9];
