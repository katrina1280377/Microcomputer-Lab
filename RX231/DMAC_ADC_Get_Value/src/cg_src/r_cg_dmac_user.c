...
/***********************************************************************************************************************
* Function Name: r_dmac_dmac0i_interrupt
* Description  : None
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
#if FAST_INTERRUPT_VECTOR == VECT_DMAC_DMAC0I
#pragma interrupt r_dmac_dmac0i_interrupt(vect=VECT(DMAC,DMAC0I),fint)
#else
#pragma interrupt r_dmac_dmac0i_interrupt(vect=VECT(DMAC,DMAC0I))
#endif
static void r_dmac_dmac0i_interrupt(void)
{
...
* Description  : This function callback function for DMAC0 transfer end.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
