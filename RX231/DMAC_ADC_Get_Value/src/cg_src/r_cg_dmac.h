...
Macro definitions
***********************************************************************************************************************/
#define _66_DMAC0_ACTIVATION_SOURCE                      (0x66U) /* DMAC0 activation source select */
#define _00089020_DMAC0_SRC_ADDR                         (0x00089020UL) /* DMAC0 source address */
#define _00000000_DMAC0_DST_ADDR                         (0x00000000UL) /* DMAC0 destination address */
#define _000000C8_DMAC0_DMCRA_COUNT                      (0x000000C8UL) /* DMAC0 transfer count in Normal/Repeat mode
                                                                           or block size count in Block mode */
#define _0000_DMAC0_SRC_EXT_RPT_AREA                     (0x0000U) /* DMAC0 source address extended repeat area */
#define _0000_DMAC0_DST_EXT_RPT_AREA                     (0x0000U) /* DMAC0 destination address extended repeat area */
