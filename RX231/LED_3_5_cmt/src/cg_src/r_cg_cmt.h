...
Macro definitions
***********************************************************************************************************************/
#define _4498_CMT0_CMCOR_VALUE                  (0x4498U) /* Compare match value */
#define _2932_CMT1_CMCOR_VALUE                  (0x2932U) /* Compare match value */
#define _CDFD_CMT2_CMCOR_VALUE                  (0xCDFDU) /* Compare match value */
