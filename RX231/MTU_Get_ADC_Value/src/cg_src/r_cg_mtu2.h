...
#define _00_MTU_I1AE_DISABLE               (0x00U) /* Does not include the MTIOC1A pin in the MTU2.TGRA 
                                                      input capture conditions */
#define _01_MTU_I1AE_ENABLE                (0x01U) /* Includes the MTIOC1A pin in the MTU2.TGRA 
                                                      input capture conditions */
/* Input Capture Enable (I1BE) */
#define _00_MTU_I1BE_DISABLE               (0x00U) /* Does not include the TMTIOC1B pin in the MTU2.TGRB 
                                                      input capture conditions */
#define _02_MTU_I1BE_ENABLE                (0x02U) /* Includes the MTIOC1B pin in the MTU2.TGRB 
                                                      input capture conditions */
...
***********************************************************************************************************************/
/* PWM2 TGRA value */
#define _034B_TGRA_VALUE                   (0x034BU)
/* PWM2 TGRB value */
#define _034A_TGRB_VALUE                   (0x034AU)
/* PWM2 TGRC value */
...
/* PWM2 TGRF value */
#define _0063_TGRF_VALUE                   (0x0063U)
