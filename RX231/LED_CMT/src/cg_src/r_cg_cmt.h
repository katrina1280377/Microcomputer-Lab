...
Macro definitions
***********************************************************************************************************************/
#define _0D2E_CMT0_CMCOR_VALUE                  (0x0D2EU) /* Compare match value */
#define _02A2_CMT1_CMCOR_VALUE                  (0x02A2U) /* Compare match value */
#define _0697_CMT2_CMCOR_VALUE                  (0x0697U) /* Compare match value */
#define _0A8B_CMT3_CMCOR_VALUE                  (0x0A8BU) /* Compare match value */
