...
void R_CMT0_Create(void)
{
    ...
    CMT0.CMCOR = _41EA_CMT0_CMCOR_VALUE;
...
void R_CMT1_Create(void)
{
    ...
    CMT1.CMCOR = _41EA_CMT1_CMCOR_VALUE;
...
void R_CMT2_Create(void)
{
    ...
    CMT2.CMCOR = _41EA_CMT2_CMCOR_VALUE;
...
void R_CMT3_Create(void)
{
    ...
    /* Set control registers */
    CMT3.CMCR.WORD = _0001_CMT_CMCR_CKS_PCLK32 | _0040_CMT_CMCR_CMIE_ENABLE | _0080_CMT_CMCR_DEFAULT;
    CMT3.CMCOR = _41EA_CMT3_CMCOR_VALUE;
