...
Macro definitions
***********************************************************************************************************************/
#define _41EA_CMT0_CMCOR_VALUE                  (0x41EAU) /* Compare match value */
#define _41EA_CMT1_CMCOR_VALUE                  (0x41EAU) /* Compare match value */
#define _41EA_CMT2_CMCOR_VALUE                  (0x41EAU) /* Compare match value */
#define _41EA_CMT3_CMCOR_VALUE                  (0x41EAU) /* Compare match value */
