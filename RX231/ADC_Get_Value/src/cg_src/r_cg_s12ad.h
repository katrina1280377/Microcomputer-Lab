...
#define _0001_AD_ADDAVG_CHANNEL_SELECT0      (0x0001U) /* Converted value add/average function select register 0 */
...
#define _FE_AD_SAMPLING_STATE_0              (0xFEU) /* AN000 sampling state register value */
