...
void R_RTC_Create(void)
{
    ...
    RTC.RMINCNT.BYTE = _28_RTC_COUNT_MINUTE_VALUE;
    RTC.RHRCNT.BYTE = _17_RTC_COUNT_HOUR_VALUE;
    RTC.RWKCNT.BYTE = _04_RTC_COUNT_WEEK_VALUE;
    RTC.RDAYCNT.BYTE = _09_RTC_COUNT_DAY_VALUE;
    RTC.RMONCNT.BYTE = _11_RTC_COUNT_MONTH_VALUE;
    RTC.RYRCNT.WORD = _0017_RTC_COUNT_YEAR_VALUE;
