...
Macro definitions
***********************************************************************************************************************/
#define _0002932F_RTC_1_64_SEC_CYCLE                (0x0002932FUL) /* Wait time = 1/64s */
#define _00_RTC_COUNT_SECOND_VALUE                  (0x00U)        /* Second value of counter */
#define _28_RTC_COUNT_MINUTE_VALUE                  (0x28U)        /* Minute value of counter */
#define _17_RTC_COUNT_HOUR_VALUE                    (0x17U)        /* Hour value of counter */
#define _04_RTC_COUNT_WEEK_VALUE                    (0x04U)        /* Week value of counter */
#define _09_RTC_COUNT_DAY_VALUE                     (0x09U)        /* Day value of counter */
#define _11_RTC_COUNT_MONTH_VALUE                   (0x11U)        /* Month value of counter */
#define _0017_RTC_COUNT_YEAR_VALUE                  (0x0017U)      /* Year value of counter */
