...
void R_SCI0_Create(void)
{
    ...
    IPR(SCI0, ERI0) = _0F_SCI_PRIORITY_LEVEL15;
    ...
    SCI0.SMR.BYTE = _01_SCI_CLOCK_PCLK_4 | _00_SCI_STOP_1 | _00_SCI_PARITY_DISABLE | _00_SCI_DATA_LENGTH_8 | 
    ...
    SCI0.SEMR.BYTE = _00_SCI_16_BASE_CLOCK | _00_SCI_BAUDRATE_SINGLE | _00_SCI_BIT_MODULATION_DISABLE;
